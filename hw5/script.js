...
function init() {
    ...
    // Add world geometry
    const coneGeometry = new THREE.ConeGeometry(30, 100);
    ...
    const material = new THREE.MeshPhongMaterial({ color: 0x6e6e6a, flatShading: true });
    ...
    const ground = new THREE.MeshPhongMaterial({ color: 0x5e440a, flatShading: true });
